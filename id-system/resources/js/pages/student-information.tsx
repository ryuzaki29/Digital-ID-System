...
import { Users, Search, Plus, Edit, Trash2, CheckCircle, Upload, X, User } from 'lucide-react';
...
export default function StudentInformation({ students }: StudentInformationProps) {
    ...
    const handleEdit = (student: Student) => {
        ...
        setData({
            ...
            campus_site: student.campus_site || '',
    ...
    const handleBatchSubmit = (e: React.FormEvent) => {
        ...
        router.post('/students/batch-upload', {
            csv_file: csvFile,
        }, {
            onSuccess: () => {
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="space-y-4 py-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={data.institution} onValueChange={(value) => setData('institution', value)}>
                                            <SelectTrigger className={errors.institution ? 'border-red-500' : ''}>
                                                <SelectValue placeholder="Select institution" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="University of the Philippines Diliman">University of the Philippines Diliman</SelectItem>
                                                <SelectItem value="University of the Philippines Manila">University of the Philippines Manila</SelectItem>
                                                <SelectItem value="University of the Philippines Los Banos">University of the Philippines Los Banos</SelectItem>
                                                <SelectItem value="University of the Philippines Visayas">University of the Philippines Visayas</SelectItem>
                                                <SelectItem value="University of the Philippines Baguio">University of the Philippines Baguio</SelectItem>
                                                <SelectItem value="University of the Philippines Cebu">University of the Philippines Cebu</SelectItem>
                                                <SelectItem value="University of the Philippines Mindanao">University of the Philippines Mindanao</SelectItem>
                                                <SelectItem value="University of the Philippines Open University">University of the Philippines Open University</SelectItem>
                                                <SelectItem value="University of the Philippines General Hospital">University of the Philippines General Hospital</SelectItem>
                                                <SelectItem value="University of the Philippines System">University of the Philippines System</SelectItem>
                                                <SelectItem value="University of the Philippines Tacloban">University of the Philippines Tacloban</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        {errors.institution && (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="campusSite"
                                            placeholder="Enter campus site"
                                            value={data.campus_site}
                                            onChange={(e) => setData('campus_site', e.target.value)}
                                            className={errors.campus_site ? 'border-red-500' : ''}
                                        />
                                        {errors.campus_site && (
                                            <p className="text-sm text-red-500">{errors.campus_site}</p>
                                        )}
                                    </div>
                                    <div className="space-y-2">
                            ...
                            <form onSubmit={handleBatchSubmit} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Upload a CSV file with columns: student_number, full_name, email, program, year_level, institution, campus_site, college, organization, status
                                    </p>
                                    <p className="text-sm">
                                        <a 
                                ...
                                <div className="flex justify-end gap-2">
                                    ...
                                    <Button type="submit" disabled={processing || !csvFile}>
                                        {processing ? 'Uploading...' : 'Upload Students'}
                                    </Button>
                                </div>
                            </form>
                        </DialogContent>
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleEditSubmit}>
                            <div className="space-y-4 py-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="editCampusSite">Campus Site</Label>
                                    <Input
                                        id="editCampusSite"
                                        placeholder="Enter campus site"
                                        value={data.campus_site}
